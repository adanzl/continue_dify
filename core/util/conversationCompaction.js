...
async function compactConversation({ sessionId, index, historyManager, currentModel, }) {
    ...
    const messages = filteredHistory.map((item) => item.message);
...
//# sourceMappingURL=conversationCompaction.js.map