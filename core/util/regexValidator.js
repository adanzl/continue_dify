...
exports.validateAndSanitizeRegex = validateAndSanitizeRegex;
exports.escapeLiteralForRegex = escapeLiteralForRegex;
exports.looksLikeLiteralSearch = looksLikeLiteralSearch;
exports.prepareQueryForRipgrep = prepareQueryForRipgrep;
/**
 ...
 */
function validateAndSanitizeRegex(query) {
    ...
    const ripgrepSpecificIssues = [
        ...
        {
            pattern: /\(\?[<!=]/,
            warning: "Lookahead/lookbehind assertions require ripgrep to be compiled with PCRE2",
        },
    ];
 ...
 */
function escapeLiteralForRegex(literal) {
 ...
 */
function looksLikeLiteralSearch(query) {
 ...
 */
function prepareQueryForRipgrep(query) {
