 ...
 */
async function* streamDiff(oldLines, newLines) {
    ...
    while (oldLinesCopy.length > 0 && !newLineResult.done) {
        const { matchIndex, isPerfectMatch, newLine } = (0, util_js_1.matchLine)(newLineResult.value, oldLinesCopy, seenIndentationMistake);
...
//# sourceMappingURL=streamDiff.js.map