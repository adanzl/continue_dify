...
exports.initSlashCommand = exports.INIT_PROMPT_CONTENT = void 0;
...
- ${builtIn_1.BuiltInToolNames.FileGlobSearch}: To discover project files
- ${builtIn_1.BuiltInToolNames.ReadFile}: To analyze file contents
- ${builtIn_1.BuiltInToolNames.LSTool}: To explore directory structure
- ${builtIn_1.BuiltInToolNames.CreateNewFile}: To generate the ${initFilename} file
...
Also inform the user that they can create additional ${constants_1.RULES_MARKDOWN_FILENAME} files in subdirectories for more specific documentation related to those components.
`.trim();
exports.initSlashCommand = {
    name: "Init",
    description: "Initialize Codebase",
    source: "built-in",
    prompt: exports.INIT_PROMPT_CONTENT,
};
//# sourceMappingURL=initPrompt.js.map