...
exports.DEFAULT_PLAN_SYSTEM_MESSAGE = exports.DEFAULT_AGENT_SYSTEM_MESSAGE = exports.DEFAULT_CHAT_SYSTEM_MESSAGE = exports.EDIT_CODE_INSTRUCTIONS = exports.CODEBLOCK_FORMATTING_INSTRUCTIONS = exports.DEFAULT_SYSTEM_MESSAGES_URL = void 0;
exports.DEFAULT_SYSTEM_MESSAGES_URL = "https://github.com/continuedev/continue/blob/main/core/llm/defaultSystemMessages.ts";
exports.CODEBLOCK_FORMATTING_INSTRUCTIONS = `\
  Always include the language and file name in the info string when you write code blocks.
  If you are editing "src/main.py" for example, your code block should start with '\`\`\`python src/main.py'
`;
exports.EDIT_CODE_INSTRUCTIONS = `\
...
exports.DEFAULT_CHAT_SYSTEM_MESSAGE = `\
<important_rules>
...
exports.DEFAULT_AGENT_SYSTEM_MESSAGE = `\
<important_rules>
...
exports.DEFAULT_PLAN_SYSTEM_MESSAGE = `\
<important_rules>
...
//# sourceMappingURL=defaultSystemMessages.js.map