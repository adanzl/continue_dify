...
exports.codestralEditPrompt = void 0;
const util_1 = require("../../../util");
const codestralInsertionEditPrompt = (_, otherData) => {
...
const codestralFullFileEditPrompt = (_, otherData) => {
    return (0, util_1.dedent) `
    \`\`\`${otherData.language}
...
const codestralEditPrompt = (history, otherData) => {
...
exports.codestralEditPrompt = codestralEditPrompt;
