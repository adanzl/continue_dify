...
const ListenableGenerator_1 = require("./ListenableGenerator");
class GeneratorReuseManager {
    constructor(onError) {
        this.onError = onError;
        this.pendingCompletion = "";
    }
    _createListenableGenerator(abortController, gen, prefix) {
        this.currentGenerator?.cancel();
        const listenableGen = new ListenableGenerator_1.ListenableGenerator(gen, this.onError, abortController);
...
//# sourceMappingURL=GeneratorReuseManager.js.map