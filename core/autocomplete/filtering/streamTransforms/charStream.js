 ...
 */
async function* onlyWhitespaceAfterEndOfLine(stream, endOfLine, fullStop) {
    let pending = "";
 ...
 */
async function* noFirstCharNewline(stream) {
    let first = true;
 ...
 */
async function* stopAtStopTokens(stream, stopTokens) {
 ...
 */
async function* stopAtStartOf(stream, suffix, sequenceLength = 20) {
