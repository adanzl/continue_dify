...
const dbinfoz_1 = require("dbinfoz");
const index_js_1 = require("../index.js");
class DatabaseContextProvider extends index_js_1.BaseContextProvider {
    ...
    async getContextItems(query, extras) {
        ...
        for (const connection of connections) {
            if (connection.name === connectionName) {
                ...
                const adapter = (0, dbinfoz_1.getDatabaseAdapter)(connection.connection_type, connection.connection);
...
DatabaseContextProvider.description = {
    title: "database",
